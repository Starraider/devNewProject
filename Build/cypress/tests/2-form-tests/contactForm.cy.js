describe('tests the contact form', () => {
  ...
  it('has contact form', () => {
    ...
    cy.findByRole('textbox', { name: /Vorname/i }).should('exist')
    cy.findByRole('textbox', { name: /Nachname/i }).should('exist')
  ...
  it('checks mandatory fields', () => {
    ...
    cy.findByRole('textbox', { name: /Vorname/i }).should('have.class', 'error')
  })
})
